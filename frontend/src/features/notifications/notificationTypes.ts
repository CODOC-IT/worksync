...
export const NOTIFICATION_TYPE_META: Record<NotificationType, NotificationTypeMeta> = {
  ...
  account_change_request_approved: { label: 'Account Change Approved', icon: CheckCircle2, tone: 'success', priority: 'Medium' },
  account_change_request_rejected: { label: 'Account Change Rejected', icon: XCircle, tone: 'error', priority: 'High' },
  account_profile_updated: { label: 'Profile Updated', icon: UserCog, tone: 'info', priority: 'Medium' },
