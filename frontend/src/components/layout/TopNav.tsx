    ...
    <header className="h-16 border-b border-white/10 glass-panel rounded-none border-x-0 border-t-0 px-3 sm:px-6 flex items-center justify-between relative z-20 shrink-0">
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 sm:px-4 py-2 rounded-xl bg-slate-900/50 border border-white/10 text-slate-400 hover:text-slate-200 hover:border-cyan-500/40 transition-all w-44 sm:w-56 md:w-72 lg:w-80 text-xs"
        >
          ...
          <kbd className="ml-auto px-1.5 py-0.5 rounded bg-white/10 border border-white/10 text-[10px] font-mono text-slate-300 hidden sm:inline">⌘K</kbd>
        </button>
      </div>
